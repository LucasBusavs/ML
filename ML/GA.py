...
def generation_KNN(generations=10, popSize=20, pCross=0.8, pMutation=0.02):
...
def generation_RF(generations=10, popSize=30, pCross=0.8, pMutation=0.02):
    # Cria uma população inicial
...
def generation_SVM(generations=10, popSize=50, pCross=0.8, pMutation=0.02):
    # Cria uma população inicial
